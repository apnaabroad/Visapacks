...
export default function CountryCard({ country }) {
  return (
    <Link
      ...
      className="group flex flex-col border border-hairline bg-ivory shadow-card transition-all duration-200 hover:-translate-y-1 hover:border-ink hover:shadow-card-hover"
    >
      ...
      <div className="flex flex-col p-6">
        ...
        <p className="mt-4 text-xs font-medium uppercase tracking-wide text-warm-gray group-hover:text-burgundy transition-colors duration-200">
